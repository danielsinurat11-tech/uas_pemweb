...
<head>
    ...
    <title>Tambah Produk - Debora Craft</title>
        ...
        <main class="main-content">
            ...
            <div class="form-section">
                <div class="form-header">
                    ...
                    <p class="form-subtitle">Lengkapi informasi produk di bawah ini</p>
                </div>
                
                <form class="product-form" method="POST" action="{{ route('admin.produk.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="category" name="category" class="form-select" required>
                                ...
                                <option value="gift_set" {{ old('category') == 'gift_set' ? 'selected' : '' }}>Gift Set</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="price" name="price" class="form-input" value="{{ old('price') }}" min="0" step="0.01" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="color" name="color" class="form-input" value="{{ old('color') }}" placeholder="Contoh: Merah, Pink, Putih">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="city" name="city" class="form-input" value="{{ old('city') }}" placeholder="Contoh: Kota Bandung">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="type" name="type" class="form-select" required>
                                <option value="standart" {{ old('type', 'standart') == 'standart' ? 'selected' : '' }}>Standart</option>
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="material_description" name="material_description" class="form-textarea" rows="4" placeholder="Jelaskan bahan-bahan yang digunakan dalam produk">{{ old('material_description') }}</textarea>
                    </div>
        ...
        function previewImage(input, previewId) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    preview.innerHTML = '<img src="' + e.target.result + '" style="max-width: 200px; max-height: 200px; border-radius: 8px; margin-top: 0.5rem;">';
                };
